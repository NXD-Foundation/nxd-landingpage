...
export default function Footer() {
  return (
    ...
    >
      <div className="w-xl h-[160px]">
        <div className="border-t-0 border-gray-100 flex flex-col items-center sm:flex sm:flex-row sm:items-center sm:justify-between h-full p-6">
          <div className="flex items-center">
            <p className="text-center text-[10px] md:text-sm text-white sm:text-left">
              Copyright © NordXDataspace Foundation 2023.{" "}
